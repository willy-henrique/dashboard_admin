...
import { AlertCircle, CreditCard, DollarSign, Loader2, PieChart, TrendingUp } from "lucide-react"
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400">Carregando dados do Pagar.me...</p>
            </div>
          </div>
        </div>
      </RouteGuard>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Dados financeiros retornados pelo Pagar.me ou payload vazio com aviso
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Transacoes aprovadas</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Cartao de Debito</span>
                ...
                {recentCharges.length > 0 ? (
                  recentCharges.slice(0, 5).map((charge, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium">{formatCurrency(charge.amount || 0)}</span>
                    </div>
                  ))
                ) : (
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Nenhuma cobranca real encontrada para o periodo atual.
                  </p>
                )}
              </div>
            </CardContent>
